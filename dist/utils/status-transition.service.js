...
class StatusTransitionService {
    ...
    static getDefaultDescription(fromStatus, toStatus, actorType, reason) {
        const descriptions = {
            ...
            [order_v2_enum_1.OrderItemStatusV2.RTO_INITIATED]: "Delivery was refused — item is being returned to seller",
            [order_v2_enum_1.OrderItemStatusV2.RTO_IN_TRANSIT]: "Refused item is in transit back to seller",
            [order_v2_enum_1.OrderItemStatusV2.RTO_DELIVERED]: "Refused item has reached the seller",
            [order_v2_enum_1.OrderItemStatusV2.RTO_APPROVED_BY_SELLER]: "Seller confirmed receipt of the refused item",
            [order_v2_enum_1.OrderItemStatusV2.MTM_REFUSED_NON_REFUNDABLE]: "Delivery was refused despite multiple attempts — this payment is non-refundable",
            [order_v2_enum_1.OrderItemStatusV2.NDR_HELD]: "Delivery attempt failed — awaiting your remaining balance payment",
            [order_v2_enum_1.OrderItemStatusV2.NDR_RELEASED]: "Balance received — item is being redelivered",
            ...
            [order_v2_enum_1.OrderItemStatusV2.ALTERATION_REQUESTED]: "Alteration request has been initiated",
            [order_v2_enum_1.OrderItemStatusV2.ALTERATION_PICKED_UP]: "Item has been picked up for alteration",
            [order_v2_enum_1.OrderItemStatusV2.ALTERATION_AT_SELLER]: "Item received by seller — alteration in progress",
            [order_v2_enum_1.OrderItemStatusV2.ALTERATION_SHIPPED_BACK]: "Altered item is on its way back to you",
            [order_v2_enum_1.OrderItemStatusV2.ALTERATION_COMPLETED]: "Alteration completed and item delivered",
...
StatusTransitionService.statusToEventMap = {
    ...
    [order_v2_enum_1.OrderItemStatusV2.RTO_INITIATED]: order_v2_enum_1.OrderEventTypeV2.RTO_INITIATED,
    [order_v2_enum_1.OrderItemStatusV2.RTO_IN_TRANSIT]: order_v2_enum_1.OrderEventTypeV2.RTO_IN_TRANSIT,
    [order_v2_enum_1.OrderItemStatusV2.RTO_DELIVERED]: order_v2_enum_1.OrderEventTypeV2.RTO_DELIVERED,
    [order_v2_enum_1.OrderItemStatusV2.RTO_APPROVED_BY_SELLER]: order_v2_enum_1.OrderEventTypeV2.RTO_APPROVED_BY_SELLER,
    [order_v2_enum_1.OrderItemStatusV2.MTM_REFUSED_NON_REFUNDABLE]: order_v2_enum_1.OrderEventTypeV2.MTM_REFUSED_NON_REFUNDABLE,
    [order_v2_enum_1.OrderItemStatusV2.NDR_HELD]: order_v2_enum_1.OrderEventTypeV2.NDR_HELD,
    [order_v2_enum_1.OrderItemStatusV2.NDR_RELEASED]: order_v2_enum_1.OrderEventTypeV2.NDR_RELEASED,
    ...
    [order_v2_enum_1.OrderItemStatusV2.ALTERATION_REQUESTED]: order_v2_enum_1.OrderEventTypeV2.ALTERATION_REQUESTED,
    [order_v2_enum_1.OrderItemStatusV2.ALTERATION_PICKED_UP]: order_v2_enum_1.OrderEventTypeV2.ALTERATION_PICKED_UP,
    [order_v2_enum_1.OrderItemStatusV2.ALTERATION_AT_SELLER]: order_v2_enum_1.OrderEventTypeV2.ALTERATION_AT_SELLER,
    [order_v2_enum_1.OrderItemStatusV2.ALTERATION_SHIPPED_BACK]: order_v2_enum_1.OrderEventTypeV2.ALTERATION_SHIPPED_BACK,
    [order_v2_enum_1.OrderItemStatusV2.ALTERATION_COMPLETED]: order_v2_enum_1.OrderEventTypeV2.ALTERATION_COMPLETED,
