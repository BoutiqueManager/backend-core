...
export const ORDER_ITEM_STATUS_COLORS: Record<OrderItemStatusV2, string> = {
  ...
  [OrderItemStatusV2.RTO_INITIATED]: STATUS_COLORS.RTO,
  [OrderItemStatusV2.RTO_IN_TRANSIT]: STATUS_COLORS.RTO,
  [OrderItemStatusV2.RTO_DELIVERED]: STATUS_COLORS.RTO,
  [OrderItemStatusV2.RTO_APPROVED_BY_SELLER]: STATUS_COLORS.RTO,
  [OrderItemStatusV2.MTM_REFUSED_NON_REFUNDABLE]: STATUS_COLORS.NON_REFUNDABLE,
  [OrderItemStatusV2.NDR_HELD]: STATUS_COLORS.MTM_HOLD,
  [OrderItemStatusV2.NDR_RELEASED]: STATUS_COLORS.MTM_HOLD,
  ...
  [OrderItemStatusV2.ALTERATION_REQUESTED]: STATUS_COLORS.EXCHANGE,
  [OrderItemStatusV2.ALTERATION_PICKED_UP]: STATUS_COLORS.EXCHANGE,
  [OrderItemStatusV2.ALTERATION_AT_SELLER]: STATUS_COLORS.EXCHANGE,
  [OrderItemStatusV2.ALTERATION_SHIPPED_BACK]: STATUS_COLORS.EXCHANGE,
  [OrderItemStatusV2.ALTERATION_COMPLETED]: STATUS_COLORS.DELIVERED,
...
> = {
  ...
  [OrderItemStatusV2.RTO_IN_TRANSIT]: "undo",
  [OrderItemStatusV2.RTO_DELIVERED]: "undo",
  [OrderItemStatusV2.RTO_APPROVED_BY_SELLER]: "undo",
  [OrderItemStatusV2.MTM_REFUSED_NON_REFUNDABLE]: "block",
  [OrderItemStatusV2.NDR_HELD]: "hourglass-empty",
  [OrderItemStatusV2.NDR_RELEASED]: "local-shipping",
  ...
  [OrderItemStatusV2.ALTERATION_REQUESTED]: "build",
  [OrderItemStatusV2.ALTERATION_PICKED_UP]: "local-shipping",
  [OrderItemStatusV2.ALTERATION_AT_SELLER]: "build",
  [OrderItemStatusV2.ALTERATION_SHIPPED_BACK]: "local-shipping",
  [OrderItemStatusV2.ALTERATION_COMPLETED]: "check-circle",
...
export const ORDER_ITEM_STATUS_COLORS_IONICONS: Record<OrderItemStatusV2, string> = {
  ...
  [OrderItemStatusV2.RTO_INITIATED]:               "#E65100",
  [OrderItemStatusV2.RTO_IN_TRANSIT]:              "#E65100",
  [OrderItemStatusV2.RTO_DELIVERED]:               "#E65100",
  [OrderItemStatusV2.RTO_APPROVED_BY_SELLER]:      "#E65100",
  [OrderItemStatusV2.MTM_REFUSED_NON_REFUNDABLE]:  "#B71C1C",
  [OrderItemStatusV2.NDR_HELD]:                    "#0284C7",
  [OrderItemStatusV2.NDR_RELEASED]:                "#0284C7",
  ...
  [OrderItemStatusV2.ALTERATION_REQUESTED]:        "#6A1B9A",
  [OrderItemStatusV2.ALTERATION_PICKED_UP]:        "#6A1B9A",
  [OrderItemStatusV2.ALTERATION_AT_SELLER]:        "#6A1B9A",
  [OrderItemStatusV2.ALTERATION_SHIPPED_BACK]:     "#6A1B9A",
  [OrderItemStatusV2.ALTERATION_COMPLETED]:        "#26704A",
...
export const ORDER_ITEM_STATUS_ICONS_IONICONS: Record<OrderItemStatusV2, string> = {
  ...
  [OrderItemStatusV2.RTO_INITIATED]:               "return-down-back",
  [OrderItemStatusV2.RTO_IN_TRANSIT]:              "car",
  [OrderItemStatusV2.RTO_DELIVERED]:               "storefront",
  [OrderItemStatusV2.RTO_APPROVED_BY_SELLER]:      "checkmark-circle",
  [OrderItemStatusV2.MTM_REFUSED_NON_REFUNDABLE]:  "close-circle",
  [OrderItemStatusV2.NDR_HELD]:                    "time",
  [OrderItemStatusV2.NDR_RELEASED]:                "bicycle",
  ...
  [OrderItemStatusV2.ALTERATION_REQUESTED]:        "construct",
  [OrderItemStatusV2.ALTERATION_PICKED_UP]:        "bag",
  [OrderItemStatusV2.ALTERATION_AT_SELLER]:        "construct",
  [OrderItemStatusV2.ALTERATION_SHIPPED_BACK]:     "bicycle",
  [OrderItemStatusV2.ALTERATION_COMPLETED]:        "checkmark-done-circle",
